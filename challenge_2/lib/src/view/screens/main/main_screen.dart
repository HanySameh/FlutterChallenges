    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: Stack(
          children: [
            Positioned.fill(
              bottom: AppConstants.kBottomNavigationHeight,
              child: IndexedStack(
        ...
        : Navigator(
            ...
            onGenerateRoute: (settings) => AppRoutes.generateRoute(
              RouteSettings(
                name: routeName,
                arguments: {
                  'offStage': screenIndex != currentIndex,
                  'callback': _onWillPop
                },
              ),
            ),
      ...
      child: Stack(
        children: [
          Align(
            ...
            child: Container(
              width: double.infinity,
              height: AppConstants.kBottomNavigationHeight,
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              label,
              style: isCurrentItem
                  ? AppTheme.lightTheme.textTheme.bodySmall!.apply(
